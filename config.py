...
COMPANY_KEYWORDS = [
    ...
    "전문건설공제조합",
    "대한기계설비건설협회",
    "기계설비협회",          # 협회 단축 표기 — 기사들이 정식명칭 대신 자주 쓰는 형태 포착
]
...
BLOCKED_CONTENT_KEYWORDS = [
    ...
    "포토월",
    "쇼호스트",
    # 종합건설사 오탐 차단 — 정몽규(HDC현산 회장) 축구협회 후원 스캔들이 "현대산업개발+계약"으로 유입(2026-07-28).
    "축구협회",
    "KFA",
]
...
HIDDEN_STORY_TITLES = [
    ...
    # 2026-07-24 겸직 후속(후보 배제 검토) — 대시보드 비노출(아카이브 유지).
    '국토부 "필요시 선출 연기·후보 배제 검토 요청"…허용주 협회장 겸직 변수로',
]
...
KEYWORD_CANONICAL = {
    "SGC E&C": "SGC이앤씨",
    "기계설비협회": "대한기계설비건설협회",   # 단축표기 → 정식명칭으로 표시 통일
}
